        ...
        <div className="tab-content" id="nav-tabContent">
          ...
          >
            <div id="home-container">
              ...
              <p>
                The Quote tab and the Authors tab are multiclickable: each time
                you click on the Quote tab will display a random quote, and the
                Authors tab will display ten random authors. The links within
                the Authors tab and the Categories tab are also multiclickable:
                a new quote from the clicked author or category is displayed for
                each click. If you would like quotes from a specific author,
                then click on the Search Author tab and type the name of your
                desired author.
              </p>
